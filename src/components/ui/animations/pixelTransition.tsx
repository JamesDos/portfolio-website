...
const PixelTransition: React.FC<PixelTransitionProps> = ({
  ...
  useEffect(() => {
    ...
    const colors = Array.isArray(pixelColor) ? pixelColor : [pixelColor];
  ...
  const animatePixels = (activate: boolean): void => {
    ...
    // Set pixel colors based on enter/leave
    const transitionColor = activate ? "#FFFFFF" : "#000000";
    pixels.forEach((pixel) => {
      pixel.style.backgroundColor = transitionColor;
    });
