    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {logoText ? (
              <span className="text-white text-2xl font-bold">{logoText}</span>
            ) : (
              <img
                      ...
                      onClick={e => {
                        if (it.link.startsWith("#")) {
                          ...
                          if (target) {
                            ...
                            console.error(`Target element not found: ${it.link}`);
                          }
                        } else {
                          // For external links (like Resume), close menu and navigate
                          closeMenu();
                        }
                      }}
                    >
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        onClick={e => {
                          // Let the link open in new tab, then close menu
...
.sm-scope .sm-socials-link::before { content: ''; position: absolute; bottom: 0; left: 0; width: 0; height: 2px; background: var(--sm-accent, #ff0000); transition: width 0.3s ease-out; }
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #ff0000); }
.sm-scope .sm-socials-link:hover::before { width: 100%; }
...
.sm-scope .sm-panel-item::before { content: ''; position: absolute; bottom: 0; left: 0; width: 0; height: 4px; background: var(--sm-accent, #ff0000); transition: width 0.3s ease-out; }
.sm-scope .sm-panel-itemLabel { display: inline-block; will-change: transform; transform-origin: 50% 100%; }
.sm-scope .sm-panel-item:hover { color: var(--sm-accent, #ff0000); }
.sm-scope .sm-panel-item:hover::before { width: calc(100% - 1.4em); }
